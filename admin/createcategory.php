        ...
        <div class="col-xl-12">
          <div class="card">
            ...
            ?>
              <tbody>
            <tr>
                <td><?php echo $row["prod_parent_id"] ?></td>
                <td><?php echo  $row["prod_name"] ?></td>
                <td><?php echo  $row["link"] ?></td>
                <td><?php echo  $row["prod_available"] ?></td>
                <td><?php echo  $row["prod_launch_date"] ?></td>
                <td><a href="#?rid=<?php echo $row["id"] ?>" class="btn btn-outline-success">Edit</a>
                <a href="delete.php?rid=<?php echo $row["id"] ?>" class="btn btn-outline-danger">Delete</a></td>
          </tr>
        </tbody>
            <?
                }
